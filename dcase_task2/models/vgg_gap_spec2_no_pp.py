...
# except:
#     from lasagne.layers import Conv2DLayer, batch_norm, MaxPool2DLayer
from lasagne.layers.dnn import Conv2DDNNLayer as Conv2DLayer
from lasagne.layers.dnn import batch_norm_dnn as batch_norm
from lasagne.layers.dnn import MaxPool2DDNNLayer as MaxPool2DLayer
...
def compile_train_strategy(fine_tune=False):
    ...
    if fine_tune:
        ini_learning_rate = np.float32(0.0002)
        max_epochs = 30
        start_decay = 5
    ...
    def get_train_strategy():
        return TrainingStrategy(
            ...
            refinement_strategy=RefinementStrategy(n_refinement_steps=0, refinement_patience=0,
                                                   learn_rate_multiplier=0.0))
